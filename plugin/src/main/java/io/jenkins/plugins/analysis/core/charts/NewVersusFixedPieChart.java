...
public class NewVersusFixedPieChart {
    ...
    public PieChartModel create(final Report newIssues, final Report outstandingIssues, final Report fixedIssues) {
        ...
        model.add(new PieData(Messages.New_Warnings_Short(), newIssues.size()), JenkinsPalette.DATA_ORANGE_LIGHT.getColor());
        model.add(new PieData(Messages.Outstanding_Warnings_Short(), outstandingIssues.size()), JenkinsPalette.DATA_YELLOW_LIGHT.getColor());
        model.add(new PieData(Messages.Fixed_Warnings_Short(), fixedIssues.size()), JenkinsPalette.DATA_GREEN_LIGHT.getColor());
